...
async function main() {
	...
	const arabicVerseData = JSON.parse(fs.readFileSync("../lib/translations/verses-ar-original.json", "utf8"));
	...
	const englishTranslationData = JSON.parse(fs.readFileSync("../lib/translations/verses-en-sam-gerrans.json", "utf8"));
